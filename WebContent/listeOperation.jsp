...
<div>
<form   action="ServletAfficherOperation" method="post">
<table >
<tr>
<td><font color=green> <h3>Entrez le Code Compte:</h3> </font></td>
<td> <input type="text" name="motCle" value="${model.motCle }"/></td>
<td> <input type="submit" value="Afficher" name="action1"/></td>
</tr>
</table>
...
<caption><font color=green><h2> Le Client ${ cpt.getC().getNom() }  ${ cpt.getC().getPrenom() } Du Compte   ${cpt.getId() } </h2></font></caption>
<tr>
<th> <h3>DateOperation</h3> </th>
<th> <h3>Type</h3> </th>
<th> <h3> montant</h3></th>
<th> <h3>  Solde </h3></th>
...
<c:forEach items="${model.operations}" var="p"> 
<tr>
<td> <h4>${p.getDateOperation() }</h4></td>
<td> <h4>${p.getType() }</h4></td>
<td> <h4>${p.getMontant() }</h4></td>
