...
<style type="text/css">
    body {
	background-image: url(images/versement.jpg);
...
<table width="346" border="0" cellspacing="0" cellpadding="0" align="right">
	<tr>
		<td width="138" height="28"><h3>Numero du compte</h3></td>
	<td><input type="text" name="numcp" 	id="numcp" title=""></td>
	</tr>
	
	<tr>
		<td height="29"><h3>Type de l'opération</h3></td>
		<td><input type="radio" name="type" id="radio1"
			value="Versement" checked="checked" />Versement <input type="radio"
			name="type" id="radio2" value="Retrait" />Retrait</td>
	</tr>
	<tr>
		<td><h3>Montant</h3></td>
