...
<td> <h4>${p.getAdresse() }</h4></td>
<td><h4> ${p.getTelephone() }</h4></td>
<td> <h4>${p.getEmail() }</h4></td>
<td> <h4>${p.getPassword() }</h4></td>
<td> <h4><a href="javascript:confirmer('ServletAfficherClient?action1=supprimer&em=${p.getEmail() }')" > Supprimer</a></h4></td>
<td><h4> <a href="modifierClient.jsp?action1=modifier&ee=${p.getId()}">Modifier</a></h4></td>
