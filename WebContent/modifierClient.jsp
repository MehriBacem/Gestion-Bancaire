...
<form method=post action="ServletModifierClient?page=modifierClient.jsp&action1=ModifierClient" name="formulaire" onsubmit="javascript: return validation();">
<fieldset>
...
<%  String ch= request.getParameter("ee") ;

    request.getSession().setAttribute("msg",ch) ; 
